...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xaf7;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(1500000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff000180b0def7d32b02e457f0e1e9ebb78e20623004d94f1b99ba621c698f66552110b17d3d80e1bc6f21014bfd0de6d840be8afe37befeadf0f9df909eef0f12859d36146b5c581229e091" ;
...
const uint64_t MAXIMUM_MIXIN_V1                              = 300;

const uint64_t MINIMUM_MIXIN_V2                              = 0;
const uint64_t MAXIMUM_MIXIN_V2                              = 250;

const uint64_t MINIMUM_MIXIN_V3                              = 0;
const uint64_t MAXIMUM_MIXIN_V3                              = 200;
...
const uint64_t DEFAULT_MIXIN_V0                              = 50;
...
const uint32_t UPGRADE_HEIGHT_V5                             = 4; // Upgrade height for CN-lail Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "LailCurrency";
...
const int      RPC_DEFAULT_PORT                              =  9090;
...
{
    {  0xb0, 0x0c, 0x4a, 0x1c, 0xcf, 0x50, 0x57, 0x41, 0x65, 0xf9, 0x90, 0xa5, 0xb6, 0xc1, 0x43, 0xe9  }
};
